      ...
      <div className="min-h-screen">
        ...
        <main>
            ...
            description={
              locale === "fr" ? (
                <>
                  ...
                  , alternant chez ATC Immobilier. Développeur full-stack
                  maîtrisant l&apos;IA générative via CLI modernes (
                  <a
                  ...
                  ) pour automatiser les workflows, optimiser les architectures
                  et accélérer le développement. Spécialisé en{" "}
                  <a
          ...
          <Section
            ...
            id="projects"
            aria-label={
              locale === "en" ? "Featured projects" : "Projets sélectionnés"
            }
          >
